...
node('dood') {
		...
		echo "$repo/$env/$service/"
            ...
            stage('Checkout Code') {
                checkout([$class: 'GitSCM', branches: [[name: '*/master']], doGenerateSubmoduleConfigurations: false, extensions: [[$class: 'SparseCheckoutPaths', sparseCheckoutPaths: [[path: 'prod/apps/myservice-app'], [path: 'prod/network']]]], submoduleCfg: [], userRemoteConfigs: [[url: 'git@github.com:sahilss429/stacks-vertical.git']]])
            }
